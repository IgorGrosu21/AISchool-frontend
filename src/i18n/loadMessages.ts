...
const loadMessagesForLocale = async (locale: string) => {
  try {
    ...
    let translations, animatedPagesTranslations, authTranslations, layoutTranslations;

    switch (locale) {
      case 'en':
        [translations, animatedPagesTranslations, authTranslations, layoutTranslations] = await Promise.all([
          import('../../messages/en/index.json').then(m => m.default),
          import('../../messages/en/animated_pages.json').then(m => m.default),
      ...
      case 'ro':
        [translations, animatedPagesTranslations, authTranslations, layoutTranslations] = await Promise.all([
          ...
          import('../../messages/ro/animated_pages.json').then(m => m.default),
      ...
      case 'ru':
        [translations, animatedPagesTranslations, authTranslations, layoutTranslations] = await Promise.all([
          ...
          import('../../messages/ru/animated_pages.json').then(m => m.default),
