 ...
 * 
 */
export const createReadonlyViewset = <RouteTypes extends RouteTypeRegistry, N extends RouteName<RouteTypes>>(
  ...
  return {
    fetch: async args => config.client.request<RouteResponse<RouteTypes, N>>({
